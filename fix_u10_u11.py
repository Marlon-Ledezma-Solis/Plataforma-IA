...
# 2. Reconstruir la división exacta entre la Unidad 10 y la Unidad 11.
# El summary de la 10 termina en "</div>`,"
# Los "videos:" que siguen pertenecen a la 11.
split_point = """            </div>`,
...
replacement_point = f"""            </div>`,
            ...
            11: {{
                ...
                title: "Unidad 11: Incorporación de IA en programación de automatizaciones",
...
if split_point in txt:
    ...
    print("Inyección U11 y separación U10 completada con éxito.")
else:
    print("ERROR: No se encontró el punto de separación.")
